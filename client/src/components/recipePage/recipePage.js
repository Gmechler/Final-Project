...
function RecipePage() {
    ...
    <div className="col-10 mt-3">
        <h1 className="text-center"> Blue Burger</h1>
        <div className="row mt-3 justify-content-center">
            <div className="col-lg-5 px-0">
                <img className="recipeImg" src={Blueburg}/>
            </div>
            <div className="col-lg-2 px-0 recipeIng">
                <h4 className="text-center mt-1">Ingredients</h4>
                <ul className="mt-1">
                    <li>stuff.</li>
                    <li>stuff.</li>
                    <li>stuff.</li>
        ...
        <div className="row mt-3 justify-content-center">
        <p className="col-lg-7 col-sm-10 mt-4">It is a long established fact that a reader will be distracted by the
