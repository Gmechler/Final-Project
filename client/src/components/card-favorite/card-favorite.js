...
<div className="col-9 card my-3 mx-1 px-0">
  <div className="row no-gutters">
    ...
    <div className="col-6">
      <div className="card-body pl-1">
        ...
        <p className="card-text favRecDesc mr-2">Lorem Ipsum is simply dummy text of the printing and
  ...
  <div className="row justify-content-center no-gutters mt-2">
        ...
        <button className="col-3 mx-1 mb-1 favResButton">Add to Meals</button>
        <button className="col-3 mx-1 mb-1 favDelButton">Remove Favorite</button>
      </div>
</div>
  );
}
